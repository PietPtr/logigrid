...
(function($PS) {
  ...
  var switchPortA = function (coords) {
      return function (state) {
          var equal = function (inp) {
              return inp.x === coords.x && inp.y === coords.y;
          };
          var toUpdate = (function () {
              var v = Data_List.filter(function (s) {
                  return !equal(s);
              })(state.inputs);
              if (v instanceof Data_List_Types.Cons) {
                  return v.value0;
              };
              throw new Error("Failed pattern match at State (line 265, column 36 - line 266, column 31): " + [ v.constructor.name ]);
          })();
          var updated = {
              statea: !toUpdate.statea,
              stateb: toUpdate.stateb,
              x: toUpdate.x,
              y: toUpdate.y
          };
          var inputs$prime = new Data_List_Types.Cons(updated, Data_List.filter(equal)(state.inputs));
          return {
              tiles: state.tiles,
  ...
  var applyInteractable = function (stateRef) {
      var findAndApply = function (state) {
          ...
          var stateFunc = (function () {
              ...
              throw new Error("Failed pattern match at Main (line 387, column 29 - line 393, column 34): " + [ v.constructor.name ]);
          })();
          return Debug.spy()(Data_Show.show(Data_Show.showRecord()(Data_Show.showRecordFieldsCons({
          ...
          })(Data_Show.showRecordFieldsNil)(Data_Show.showInt))(Data_Show.showInt)))(coords))(stateFunc(state));
      };
      return function __do() {
          var state = Effect_Ref.read(stateRef)();
