...
(function($PS) {
  ...
  var execFrame = function (stateRef) {
      return function (canvas) {
          return function (w) {
              return function __do() {
                  draw(stateRef)(canvas)();
                  Web_HTML_Window.requestAnimationFrame(execFrame(stateRef)(canvas)(w))(w)();
                  return Data_Unit.unit;
              };
          };
      };
  ...
  var main = Data_Functor["void"](Effect.functorEffect)(function __do() {
      ...
      if (v instanceof Data_Maybe.Just) {
          ...
          Web_HTML_Window.requestAnimationFrame(execFrame(state)(v.value0)(w))(w)();
          return Data_Unit.unit;
      };
      throw new Error("Failed pattern match at Main (line 28, column 5 - line 28, column 49): " + [ v.constructor.name ]);
  });
  exports["main"] = main;
