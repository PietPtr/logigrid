...
(function($PS) {
      ...
      return function (coords) {
          return function (state) {
              var tile = (function () {
                  ...
                  throw new Error("Failed pattern match at State (line 256, column 32 - line 257, column 24): " + [ v.constructor.name ]);
              })();
  ...
  var switchPortA = switchPort(function (tile) {
      return {
          statea: !tile.statea,
          stateb: tile.stateb
      };
  });
  var switchPortB = switchPort(function (tile) {
      return {
          statea: tile.statea,
          stateb: !tile.stateb
      };
...
(function($PS) {
  ...
  var keyHandler = function (b) {
      return function (state) {
          return function (event) {
              ...
              throw new Error("Failed pattern match at Main (line 315, column 9 - line 315, column 42): " + [ v.constructor.name ]);
          };
      };
  };
              ...
              return function (drawx) {
                  return function (drawy) {
                      return function (scale) {
                          ...
                          throw new Error("Failed pattern match at Main (line 202, column 5 - line 204, column 89): " + [ v.constructor.name ]);
                      };
                  };
              };
          };
                      ...
                      var ifDraw = function (isActive) {
                          return function (name) {
                              ...
                              if (isActive) {
                                  ...
                                  throw new Error("Failed pattern match at Main (line 284, column 29 - line 286, column 53): " + [ v2.constructor.name ]);
                              };
                              return Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit);
                          };
                      };
              ...
              return function (ctx) {
                  return function (v) {
                      ...
                      var drawLutConfig = function (v1) {
                          ...
                          return drawFromImageMap(state)(ctx)(value(v1.value0))(v2.value0)(v2.value1 + Data_Int.toNumber(v1.value1) * 0.126 * tilesize)(tilesize);
                      };
                      return function __do() {
                          drawSVGat("tile")(v.value0)(state)(ctx)();
                          Data_Foldable.traverse_(Effect.applicativeEffect)(Data_List_Types.foldableList)(drawLutConfig)(Data_List.zip(v.value1.config.lutConfig)(Data_List.range(0)(3)))();
  ...
  var updateTile = function (state) {
      return function (v) {
          var searchInputs = (function () {
              ...
              throw new Error("Failed pattern match at Main (line 190, column 40 - line 191, column 28): " + [ v1.constructor.name ]);
          })();
          var searchIOSwitches = (function () {
              ...
              throw new Error("Failed pattern match at Main (line 194, column 44 - line 196, column 54): " + [ v1.constructor.name ]);
          })();
          ...
          var lutOut$prime = (function () {
              var v1 = Data_List.index(v.value1.config.lutConfig)(lutID);
              if (v1 instanceof Data_Maybe.Just) {
                  return v1.value0;
              };
              throw new Error("Failed pattern match at Main (line 175, column 35 - line 176, column 32): " + [ v1.constructor.name ]);
          })();
  ...
  var keyPressHandler = function (stateRef) {
      return function (event) {
          ...
          throw new Error("Failed pattern match at Main (line 334, column 9 - line 334, column 42): " + [ v.constructor.name ]);
      };
  };
